...
SELECT * 
FROM `student` 
WHERE email LIKE '%.fr%' OR created_at <= '2021-01-11 00:00:00'
...
SELECT * 
FROM `student` 
WHERE email LIKE '%.fr%' AND created_at <= '2021-01-11 00:00:00'
...
SELECT *
FROM project
WHERE description NOT LIKE '%Dolores%' OR delivery_date >= '2021-07-01 00:00:00';
...
SELECT *
FROM project
WHERE description NOT LIKE '%Dolores%' AND delivery_date >= '2021-07-01 00:00:00';
...
SELECT *
FROM project
WHERE delivery_date > '2021-01-01 00:00:00' AND delivery_date <= '2021-07-01 00:00:00';
